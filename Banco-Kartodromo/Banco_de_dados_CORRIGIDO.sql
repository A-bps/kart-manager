...
insert into Cidade (nome, uf_sigla) values ('Uberlândia', 'MG')        -- CORRIGIDO: removido espaço extra
...
insert into Pessoa (nome, cpf, email, fone, cep_numero) values ('Patricia Souza',   '84027195016', 'patriciasouza@gmail.com',  '47991827364', '89201130')  -- CORRIGIDO: removido espaço extra
...
-- CORRIGIDO: pessoas 21-30 precisam estar em Funcionario antes de Gerente (FK chain)
...
-- INSERTS - KART
-- =========================================
-- CORRIGIDO: Kart 2 tinha estado 'Em manutenção' porém sua manutenção está com status 'Concluída' — corrigido para 'Disponível'
insert into Kart (estado, historico) values ('Disponível',     'Motor revisado recentemente')
insert into Kart (estado, historico) values ('Disponível',     'Troca de pastilha de freio')    -- CORRIGIDO: era 'Em manutenção' (manutenção já concluída)
...
-- =========================================
-- CORRIGIDO: substituídos karts indisponíveis por karts com estado 'Disponível'
-- Corrida 4: kart 9 (Indisponível) → kart 1 (Disponível)
-- Corrida 6: kart 2 (estava Em manutenção) → agora Disponível após correção do estado
-- Corrida 8: kart 6 (Em manutenção)       → kart 5 (Disponível)
-- Corrida 9: kart 4 (Indisponível)        → kart 7 (Disponível)
...
insert into Corrida_Kart (corrida_nr, kart_codigo) values (4,  1)   -- CORRIGIDO: era kart 9 (Indisponível)
insert into Corrida_Kart (corrida_nr, kart_codigo) values (5,  5)
insert into Corrida_Kart (corrida_nr, kart_codigo) values (6,  2)   -- OK: kart 2 agora está Disponível
insert into Corrida_Kart (corrida_nr, kart_codigo) values (7,  10)
insert into Corrida_Kart (corrida_nr, kart_codigo) values (8,  5)   -- CORRIGIDO: era kart 6 (Em manutenção)
insert into Corrida_Kart (corrida_nr, kart_codigo) values (9,  7)   -- CORRIGIDO: era kart 4 (Indisponível)
